...
Currently, \gls{pig} hides the \glspl{digger} in rooms underneath, as they help \gls{pigowner} move things in and out of the city without going through the \glspl{sunGuard} at the gates.%
...
The \glspl{digger} sit in the stale here, playing card-games, and plotting how to avoid work.
...
hidden under clothes, alcohols, and poisons, all lying about without labels.
...
If the troupe have more than one torch between them, they feel light-headed, as hypoxia sets in.%
