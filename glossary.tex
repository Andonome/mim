...
\newcommand\spiderqueen{
  \Person{\NPC{\F\El}{\Glsentrytext{spiderqueen}}{Like a spider-centaur, with six legs on the bottom, by a bulging thorax}{Looks down at her babies}{to see her babies in action}}%
    ...
    {}% KNACKS
    {2 dry sponges (Fire and Air \glspl{ingredient})}% EQUIPMENT
...
\newcommand\southSeeker{
  \Person{\NPC{\M\Hu}{\glsentrytext{southSeeker}}{Quiet}{Clicks tongue}{arcane knowledge}}%
    {{1}{0}{-1}}% BODY
    {{2}{0}{0}}% MIND
    {
      \set{Projectiles}{1}
    ...
    {\snapcaster}% KNACKS
    {Air \gls{ingredient} \boxStat{r2}, \lootMedium}% EQUIPMENT
    {}% ABILITIES
}
