...
\newglossaryentry{sewerthief}{
  ...
  type={people},
  parent={whiteBandits},
  description={just wants to enjoy life's comforts, but has to travel between a stinking sewer, and the \glsentrytext{necromancer}'s crumbling temple to fetch more coins.
  \\
  \\
