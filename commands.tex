...
\newcommand\deathStormSpell{
  \spell{Marshweed}% Name
    ...
    They cover an area of \arabic{spellTargets} \glspl{step}, inflicting \arabic{spellPlusTwo}~\glspl{ep} to anyone in the area who breathes it in}% Description
    {}
}
...
\newcommand\thornSeneschal{
  \NPC{\M\Hu}{Thorn the Seneschal}{practical}{scratches nose}{a quiet life}
  \person{0}% STRENGTH
  {1}% DEXTERITY 
  {-1}% SPEED
  {{1}% INTELLIGENCE
...
\newcommand\mphlg{
  ...
  {Nothing}% EQUIPMENT
  {
    ...
    \setcounter{mp}{5}
    \renewcommand\abilities{\mutation{r2}, \stepcounter{track}\mutation{track}}
  }
}

\newcommand\uncommonlyLargeJelly{
  \swarm[\gloopy, \acidSpray, \berserker, \unstoppable]{Uncommonly Large Ooze}% Name
  {\value{16}}% HP
  {\value{4}}% Attack
  {\value{0}}% Speed
  {\value{-2}}% Wits
