...
\Pgls{segment} might have the \glspl{pc} meet a \gls{seeker} of the \gls{templeOfCuriosity} in the forest, who's up to no good, but it will never start with the \glspl{pc} in \gls{whitehorse} -- that would be presumptuous.
