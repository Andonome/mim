\sidequest[Town,Roads]{The \Glsentrytext{whiteBandits}}
...
\begin{exampletext}
  A month ago, \pgls{guard} reported finding a ruined temple to \gls{traitor}.%
  ...
  They also received an arrow wound from \gls{necromancer}.
  \Gls{banditking} has decided to take it upon himself to deliver them to Lakeside.%
