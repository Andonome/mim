...
\begin{enumerate}
  ...
  \item{The troupe refused to gather payment from the local peasants, but have sworn a blood oath to kill Village Master Cronblight.}
\end{enumerate}
...
{The troupe hear more of the Wolf Heads}% SUMMARY
...
{The troupe encounter the Wolf Heads again, who lend a hand}% SUMMARY
...
\sqpart{Villages}% AREA
{A Cry for Help}% NAME
{The troupe find the Wolf Heads attacked by ogres}% SUMMARY
