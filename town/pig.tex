...
\footnote{See downstairs, \gls{area}~\vref{farmExit} for the exterior route.}
...
\begin{dlist}
  ...
  The \glspl{pc} might recognize him from the encounter \vpageref{sewerPt1}.
  \item
  \Gls{southCook} drinks in the corner with \gls{pigowner}.
  \item
  $1D6$ \glspl{diggers} have arrived to enter room (\vref{pigPrivate}) and then move underground.
  \item
...
Anyone searching hard enough can also find \lootTalisman,
recently stolen from \gls{alchemist}
(find it \vpageref{talismanIndex}).

\mapentry[pigRoom]{\Glsentrytext{pigowner}'s Room}

\Gls{pigowner} lives in a mess of old notes about what she owes to whom, chests of illegal-amounts of \glspl{weapon}%
...
A couple have items, such as daggers, or saved \glspl{coin} stuffed into obscure locations in the room.
In total, \lootMedium\ exists stuffed into horse-hair pillows and the shadows under corners.
