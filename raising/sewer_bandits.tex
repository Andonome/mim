...
\Gls{sewerthief} forgot to lock a door properly, and a room of \glspl{ghast} escaped via \nameref{slum_exit} (area \vref{slum_exit}).
...
The \glspl{ghast} move together, but slightly spread out across the alleys, no more than 20~\glspl{step} apart.
