...
\Glspl{crawler} hibernate over \gls{cTwo}, so if \gls{fenestra}'s Winter is about to hit, skip this \gls{sq} until \gls{fenestra} returns to the \gls{ainumar}'s warmth in \gls{cThree}.
