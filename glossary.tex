...
\NPC{\M\El}{\Glsentrytext{elfprince}}{Precise}{Flat palms}{Experience}
  ...
  {1}% COMBAT
  {
    ...
    \Path{\aldaron~3, \enchantment~2, \fate~2, \force~1}
  }% SKILLS
...
\person{0}% STRENGTH
  ...
  {1}% COMBAT
  {
    ...
    \Path{\aldaron~3, \fate~2, \polymorph~4}
  }% SKILLS
...
\person{1}% STRENGTH
  ...
  {1}% COMBAT
  {
    ...
    \Path{\conjuration~3, \illusion~3, \necromancy~3, \saurecanta~2}
  }% SKILLS
