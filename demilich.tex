...
\begin{exampletext}
  ...
  And since the \gls{bskulls} was not undead (despite its body of three bladders, inflated eternally, and stuffed inside three skulls), it could absorb the magical energies of the world.

  \Gls{necromancer} and the \gls{bskulls} Philosophized, and watched the birds together, and forgot that time existed.
...
If they succeed, find the temple \vpageref{necromancers_lair}.

\subsubsection*{Returning the \Glsfmttext{bskulls}}
...
\Gls{necromancer} cast it on him in order to communicate, and continuously ask where his `beloved \Glsfmttext{bskulls}' went.
