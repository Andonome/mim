...
{A knight of the local \gls{wheat} starts fights while pretending to be from the \gls{wheat} of \glsentrytext{southDale}}% SUMMARY
...
\begin{boxtext}
  ...
  The crowd shout for them to go back to the mountains and that they're not welcome in the area, but a dwarf, covered in metal from head to toe, and wearing the emblem of the \gls{wheat} from \gls{southDale}, lifts his metal visor and shouts back at them, listing a litany of laws concerning public houses and the rights of foreign Guild \gls{nomad}, with deafening volume.
...
{People jeer at envoys from \glsentrytext{southDale} \gls{wheat} and a fight breaks out}% SUMMARY
