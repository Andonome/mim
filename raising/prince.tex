\thread[Roads,Forest]{The Little Nomad}
\label{littleprince}
\index{Elves!Nomad}

\noindent
Men of the \gls{whiteBandits} rob an elf of his jewellery.
If the characters help the elf, the elf's friends drop by later to help them in a time of need.
If they join the bandits robbing the elf, the elf's friends will take vengeance later.

\segment{Forest}% AREA
{The Nomad}% NAME
{\Glsfmtplural{whiteBandits} attack a travelling elf}% SUMMARY

\begin{boxtext}
  A voice in the distant forest cries out.
  \begin{speechtext}
    I'll summon \gls{griffin} to pull your stomach out!
    I'll enchant you to make you eat until your stomach explodes!
  \end{speechtext}
...
An \roll{Intelligence}{Empathy} roll (\tn[10]) can indicate that the \glspl{pc} know some of their names (or, on a tie, they feel at leat one face is familiar).
...
\paragraph{If saved,}
\gls{elfprince} will promise to repay the characters sometime, makes allusions to an unhappy home-life, and leaves soon after.

\begin{speechtext}
  Had you seen my home, you would not worry about the forest's dangers.
  But my mother must have her hobbies, so I'm going to see the sea, and perhaps find a new life upon the waves.
\end{speechtext}

\Gls{elfprince}'s mother is \gls{spiderqueen}, though he will only speak about her in vague terms.
...
then they eventually run into a troupe of elves (in the next \gls{segment}).
...
If the \glspl{pc} aided \gls{elfprince} before, the troupe will aid them in return.
If the characters harmed \gls{elfprince}, the elven troupe will have heard of it from the Seaward Pendant.
