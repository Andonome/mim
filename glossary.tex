...
\longnewglossaryentry{wolfhead}{
  ...
  I've saved up some \glsfmtplural{coin}, and \glsentrytext{beardedalemaster}'s found some contact willing to smuggle Dwarven ales into \glsentrytext{town} for her.
...
\longnewglossaryentry{lochWarden}{
  ...
  He helps \glsentrytext{beardedalemaster} smuggle her barrels into \glsentrytext{valley} from \glsentrytext{southDale}, and sells weapons to \glsentrytext{banditking} for stolen goods from local \glsfmtplural{warden}}
}
...
\longnewglossaryentry{beardedalemaster}{
  name={Yerina},
  prefix={Chef\space},
  type={people},
  category={people},
