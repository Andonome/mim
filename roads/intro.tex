...
\noindent
Most sessions will begin with the \glspl{pc} waking in \pgls{broch}, then heading out on a mission to help \pgls{village}, or do something in the forest.
That makes this \gls{region} the most common, so it also has the most full-length \glspl{segment}.
