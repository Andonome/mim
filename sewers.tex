...
\begin{exampletext}
  ...
  \histEvent{6069}{11}{The \glsfmttext{sunGuard} attack the \glsfmttext{digger} catacombs  They learn to use smoke to defend their small turf}
...
\begin{exampletext}
  ...
  Gritbite digs whenever she can, making an entrance to \gls{townmaster}'s citadel.
\end{exampletext}
