...
\begin{boxtable}[cX|ccX]
  ...
  \hline
  \ref{citadel} & The Citadel of \glsentrytext{townmaster}. & & XX & \Glsentrytext{pig}. \\
  \ref{guardstation} & \Glsentrytext{sunGuard} Station.          & & \ref{townHealersGuild} & \Gls{healersGuild}. \\
  XX & \Glsentrytext{whitehorse}.                     & & \ref{smugglerHouse} & \gls{traitor}'s house, with secret entrance to the Lost Library. \\
  \ref{paperGuild} & \Gls{paperGuild}.                         & & \ref{armourHall} & \Gls{armourHall}. \\
\end{boxtable}
