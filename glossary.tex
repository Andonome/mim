...
\newglossaryentry{investigator}{
  name={Burngrot},
  first={Builder Burngrot of the \gls{guard}}
  type={peeps},
  prefix={Builder},
  category={people},
  parent={establishment},
  symbol={\M\Hu\gls{beasts}},
  description={grew up in \pgls{warden}'s house in \gls{southDale}, then joined the \gls{guard}, because nowhere else wanted him},
}
