...
\newglossaryentry{archwarp}{
  ...
  parent={lostcity},
  category={location},
  description={holds an alchemical gateway which once took people to Sixshadow, but now lies in disrepair, since the gateway stopped working, and an alchemist killed the gate's guardians}
}
