...
\ifnum\value{r12}>20
  \begin{boxtable}[XXXcc]
    ...
    \textbf{Armour} & \textbf{Covering} & \textbf{\Gls{dr}} &\textbf{Weight} & \textbf{Cost} \\\hline
    Partial Leather & 3 & 3 & 1 & \mkPrice{8} \\

    Complete Leather & 5 & 3 & 2 & \mkPrice{12} \\

    Partial Chain & 3 & 4 & 1 & \mkPrice{23} \\

    Complete Chain & 5 & 4 & 2 & \mkPrice{33} \\
...
\begin{boxtable}[XXXXXX]
  ...
  \shortsword & \arabic{weaponBonus} & \arabic{damage} & \arabic{heft} & \arabic{weight} & \mkPrice{9} \\

  \spear & \arabic{weaponBonus} & \arabic{damage} & \arabic{heft} & \arabic{weight} & \mkPrice{7} \\

  \longsword & \arabic{weaponBonus} & \arabic{damage} & \arabic{heft} & \arabic{weight} & \mkPrice{11} \\
