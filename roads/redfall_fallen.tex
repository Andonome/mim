...
\noindent
If the citizens of \gls{town} overrun \gls{redfall} (see \autopageref{mastersBounty}), and goblins escape from under \gls{greentower} (`\nameref{catacombsUnderTower}', \vpageref{catacombsUnderTower}) then the goblins take up permanent residence in \gls{redfall} keep.
...
\ogre[\npc{\M\N}{Roch-Hucking \Glsfmttext{ogre}}]
