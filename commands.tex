...
\newcounter{startingYear}
  \setcounter{startingYear}{\thefenestraYear}

\newcommand\histEvent[3]{%
    \setcounter{track}{\thestartingYear}%
    \setcounter{diceNo}{#1}%
...
\newcommand\sewerMap[1][b]{
  \mapPic{t}{Dyson_Logos/sewer}{
    ...
    \large\nameref{sewerShrine}/52/85,
    \Large\ref{sewerMushrooms}/32/67,
    \large\nameref{sewerMushrooms}/30/73,
  }


}

\newcommand\oldTempleMap[1][b]{
  \mapPic[\Large]{#1}{Dyson_Logos/qualme_temple}{
...
\newcommand\stirgeGhouls[1][\npc{\D\Hu}{Stirge-Infected \Glsfmttext{ghoul}}]{
  \Person{#1}%
    {{r2}{0}{0}}% BODY
    {{-6}{-1}{-6}}% MIND
    {%
