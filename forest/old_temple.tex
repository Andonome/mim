...
Inside, ancient treasures:%
\footnote{The old \gls{templeOfSickness} collected tributes from the people, which generally just piled up around the room.
...
\begin{itemize}
  ...
  \item
  A desk with letters, including praise for the \gls{shadowGate}, and complaints about how nobody visits this area, as they have no gateway.
  \item
  A workshop bench with pieces of armour on it, including a complete suite of chain armour (suitable for someone with Strength +1 to +2, but useless without the padding).
  \item
  Degraded coats, with as many holes as a spiderweb.
  \item
