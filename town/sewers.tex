...
Consult the chart (no matter which door the \glspl{pc} open first, that's the first door), and pick some ghasts from the \glspl{statblock} \vpagerefrange{newlyMintedGhastsI}{newlyMintedGhastsII}
