...
\begin{exampletext}
  ...
  to \gls{traitor}, \gls{traitor} went to investigate with \gls{banditking}.
  At first, it appeared abandoned, so \gls{banditking} picked up some interesting items he found in the hall.
