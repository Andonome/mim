...
This creates an unplanned (but excellent) ambush, as anyone moving inside simply feels an `uneven' floor as they trample over the ghouls.
...
Looking over these books requires \pgls{interval}, and each of the players should decide if they want to roll a check themselves (so the group can recover more valuables faster) or if they want their character to search with another \gls{pc}, to perform a Team Action (which would usually grant a Bonus).
