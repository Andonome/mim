...
\begin{itemize}
  ...
  \item
  Researching the Shadow Gate reveals a related book called `\nameref{bookOfFingers}' (see \vpageref{bookOfFingers}, \autoref{bookAppendix}.)
\end{itemize}
