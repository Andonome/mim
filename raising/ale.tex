...
{\Glsfmtname{sunCaptain}}% NAME
{\Glsentrytext{sunCaptain} introduces himself}% SUMMARY

\Gls{sunCaptain} is heading home after a long night (if this is the afternoon, it's been a \emph{very} long night).
...
Simply knowing \gls{sunCaptain} and where he stays could suggest to the players that they can report \gls{alemaster} or \gls{southCook}, as long as they have any evidence.
