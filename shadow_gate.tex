...
\histEvent{5979}{9}{An alchemist opens a second gateway in Sixshadow's Vault called `the Vore Gate'.
It goes to the wrong place, and dangerous creatures occasionally emerge from that labyrinthine realm.
The proprietor seals the new gate in its own room}
