...
\histEvent{5973}{6}{Sixshade becomes an attraction, with a `Vault' of magical \glsfmtplural{artefact}, and plenty of traders happy to pay to access the magical gateway \glsfmtplural{sickness}}
\begin{exampletext}
  Sixshade began as a tiny settlement, but when `the Vault' gained its gateway to Archwarp, the community flourished.
...
\histEvent{5979}{9}{An alchemist opens a second gateway in Sixshade's Vault called `the Vore Gate'.
