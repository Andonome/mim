...
\begin{description}
  ...
  The \glspl{diggers} then lock these sick, rich people in little alcoves in their \nameref{sewers}, and use \pgls{artefact} to turn them into \glspl{ghast} -- sentient undead, ready to kill (\vpageref{sewerPt2}).
  \item[Phase II]
  involves digging a tunnel underneath \gls{town}'s citadel (\vpageref{citadel}).
  \item[Phase III]
  is to release the \glspl{ghast} into the citadel while lighting a rancid fire underneath, and let undead-nature take its course (\vpageref{deadRise}).
\end{description}
\null
