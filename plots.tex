...
\begin{speechtext}
  ...
  \Gls{townmaster} has paid a handsome sum to have a few more sent over to guard the \gls{edge} around \gls{valley}.
...
Of course, \gls{valley}, \gls{southDale}, and \gls{whiteplains} will have to enter your map, from one side or another.
...
Once they have \pgls{pc}, we add one more roll to check where they come from.

\paragraph{Humans}
who enter the \gls{guard} due to being convicted of a crime

\begin{dlist}
  \item
  The character comes from \gls{town}, born and raised.
  ...
  \item
  The character comes from \gls{southDale}, but was stationed here immediately after their trial.
  They have heard of the \glspl{wolfhead}, and heard that some have engaged in violent crimes, but never convicted.
  \item
  The character comes from \gls{redfall}, but has no idea about the current crisis.
  \item
  The character comes from one of the outer \glspl{village} in \gls{valley}, and has grown up with old-fashioned songs about \gls{lostcity}.
  \item
  The character comes from \gls{whiteplains}, with bitter memories of the \glspl{keeper} there pushing far too many people into the \gls{guard} without good reason.
  \item
  The character comes from a distant land, North of \gls{southDale}.
