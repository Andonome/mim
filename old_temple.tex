...
Once the horde of the dead arrive in front of the troupe, this presents the players with a problem -- they can outrun the dead until they become tired; but they cannot hide, and the dead do not tire.
...
This clue might show the \glspl{pc} that \gls{traitor} came here, since he contracted the disease while stealing from \gls{necromancer} with the \gls{whiteplains} brothers.%
\footnote{\label{broTheftRef}Check \gls{segment} \ref{rottenBreath} of \nameref{entitlement} \vref{rottenBreath}.}
