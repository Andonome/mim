...
\NPC{\F\Hu}{Hordcut the Guard}{arrogant}{`ha!, yea right\ldots'}{a promotion}
\person{1}% STRENGTH
  {2}% DEXTERITY 
  {0}% SPEED
  {{0}% INTELLIGENCE
  ...
  {\shortsword, \partialplate}% EQUIPMENT
  {}
...
\NPC{\M\Hu}{Spybroth}{doomsayer}{sings `nobody knows the trouble I've seen'}{freedom}
\person{1}% STRENGTH
{0}% DEXTERITY 
{1}% SPEED
{{0}% INTELLIGENCE
