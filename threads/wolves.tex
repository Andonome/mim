...
\begin{speechtext}
  ...
  \\
  \rotatebox{-2}{\underline{I say} whoever draws a beast's blood first gets rights to the spoils.}
  ...
  \rotatebox{2}{I hear the \gls{witch} works for the
  \\\gls{templeOfCuriosity}.
    He can come round here, and cure my curiosity, eh?}
\end{speechtext}
