...
\sqpart{Town}% AREA
{Guards, Guards!}% NAME
{Vagabonds from the \glsentrytext{guard} run amuck in \glsentrytext{town}}% SUMMARY
...
\humanthief[\npc{\T[2]\E\Hu}{\arabic{noAppearing} \Glspl{diggers}}]
...
\sqpart{Town}% AREA
{The Dead Rise}% NAME
{\Glsfmttext{sewerking} releases ghouls upon \glsentrytext{citadel}}% SUMMARY
...
\begin{exampletext}
  ...
  \footnote{See the sewers, \gls{area} \vref{citadelTunnel} for the underground tunnel, and \gls{town}'s \gls{area}~\vref{citadel} for \glsentrytext{citadel}.}
