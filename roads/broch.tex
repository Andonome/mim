...
\mapPic{b}{extracted/cinderfilch}{
  \large\glsentrysymbol{paik}/47/95,
}
...
\widePic[t]{Dyson_Logos/broch_map}
...
\footnote{Find suggestions for the first session \vpageref{theOpeningSession}.}
...
\begin{enumerate}
  ...
  meat, and two wooden boxes full of salt to preserve the valuable
