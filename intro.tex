...
It kept a few patterns, designed to fit worlds which no longer exist.
...
\randomdozen
Every man, woman, and spider in the book has a statblock, with \glsentrylongpl{hp} boxes, like this: \setcounter{wounds}{3} \boxStat{r12}, so you can score through them with the fanciest pen you have (that's right -- real GMs use pens).
...
They evolved over many iterations to bunch \glspl{npc} people together into packs, so the death of \pgls{npc} may twist or scar the plot, but should never break it.
