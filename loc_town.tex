...
She can't find one of her cats (he's gone to \gls{pig}, \vpageref{pigCat}),
...
%\ldots{`Mouser', `Mixer', and `Fagin', are in the library, but `Blob' has gone missing.}
\label{paperCat}
...
\begin{enumerate}
  ...
  \item{First Floor: Insiders}
    \begin{itemize}
      ...
      Left Wing: Office.
      \item
      Left Wing: Library.\index{Library!Citadel}
      \item
