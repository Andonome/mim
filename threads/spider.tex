...
\ifnum\value{cycle}>1
  \Glspl{crawler} hibernate over \gls{cTwo}, so if your game takes place around \gls{cOne}, and \gls{fenestra}'s Winter is about to hit, just run \gls{segment} \ref{spiderDreams}, and leave the rest until \gls{fenestra} returns to the \gls{ainumar}'s warmth in \gls{cThree}.
\else
...
\begin{nametable}{What they see\ldots}
  ...
  9 & Bilefen decideds to \gls{retreat}. \\
