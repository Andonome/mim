...
Looking over these books requires \pgls{interval}, and each of the players should decide if they want to roll a check themselves (so the group can recover more valuables faster) or if they want their character to search with another \gls{pc}, to perform a Banding Action (which would usually grant a Bonus).%
