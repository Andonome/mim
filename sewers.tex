...
Searching the books for meaningful information requires a Banding roll of \roll{Intelligence}{Academics}.
...
\showStdSpells[
    \revelationSpell
    \stepcounter{enc}
    (full spell on \vpageref{Screaming Revelation})
]

\mapentry[sewerLockup]{Dead Rooms}

\begin{exampletext}
  The \glspl{digger} have been kidnapping rich people from the \gls{templeOfSickness} above, and locking them in the little rooms around the catacombs.
...
No matter how they present, she won't tell them about the \glspl{digger}' plan.
...
\mapentry[sewerMushrooms]{Marching Mushrooms}

The \gls{digger} grow marching mushrooms down here, used to stupefy the sick \glspl{warden} and other rich people receiving care in the \gls{healersGuild}.
