...
\newglossaryentry{whiteplains}{
  ...
  type={peeps},
  category={location},
  description={is an open land in the North-West, with only one river it can use for trade with the outside -- the river which flows through \glsentrytext{town}},
}
...
\newcommand{\sewerthief}{
  \label{sewerthief}
  \Person{\NPC{\M\Hu}{\Glsfmttext{sewerthief}}{acne scars, tubby body, with vacant eyes}{looking about, suspiciously}{just to get to the next meal}}%
    {{1}{2}{2}}% BODY
    {{-1}{1}{1}}% MIND
    {
      \setcounter{Projectiles}{2}
...
\newcommand\citadelAlchemist{
  \humanalchemist[\NPC{\M\Hu}{\Gls{alchemist}, the Alchemist}{Like a stage magician, dressed for a funeral}{Counts everything at every opportunity}{to marry \glsentrytext{librarian}}]
}
