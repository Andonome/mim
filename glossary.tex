...
\newglossaryentry{southDale}{
  name={Southdale},
  description={is a set of towns, some distance to the South of \glsentrytext{town}.
...
\newglossaryentry{outsiders}{
  ...
  sort={Outsiders},
  text={outsiders},
  description={are the various non-human people who live around the \glsentrytext{valley}.
  They have no social connections, and do not have much contact with each other, but they \emph{do} have a set of shred interests in the local humans not causing too much trouble},
}

\newglossaryentry{whiteBandits}{
  name={The White Bandits},
  sort={White Bandits},
  text={the White Bandits},
...
\newglossaryentry{wolfhead}{
  ...
  text={Wolf Head},
  sort={Wolf Heads},
  description={have heard of the legendary \glsentrytext{lostcity}, and the magical portals it held underground.
...
\newglossaryentry{townmaster}{
  ...
  He doesn't know about the plots around him, and doesn't want to know, he only wants to collect his hefty taxes on all the goods coming from \glsentrytext{whiteplains}}
}
...
\newglossaryentry{alemaster}{
  ...
  type={people},
  parent={establishment},
  description={is the highest ranking member of the \glsentrytext{wheatGuild}. Also known locally as `that damned Yerina'.
...
\newglossaryentry{beardedalemaster}{
  ...
  type={people},
  parent={wolfhead},
  description={is the leader of the \glsentrytext{wheatGuild} in \glsentrytext{southDale}, and plans to become rich selling watered-down dwarvish ale.
...
\newglossaryentry{southSeeker}{
  name={Kinbrine},
  first={\Glsfmttext{seeker} Kinbrine},
  type={people},
  parent={wolfhead},
  description={is a member of \glsentrytext{southDale}'s \glsentrytext{paperGuild}, here to collect information on \glsentrytext{lostcity}, and potentially reinstate an underground road, to bypass tax laws},
}
...
\newglossaryentry{elfprince}{
  ...
  type={people},
  parent={outsiders},
  description={is known across the land for his song, at least among the elves.
  Unfortunately, the violence and animosity sweeping the land routinely puts him in danger}
}
...
\newglossaryentry{necromancer}{
  ...
  type={people},
  parent={whiteBandits},
  description={was a priest of \glsentrytext{eldren} a couple of centuries ago.
  ...
  He currently trades with the \glsentrytext{whiteBandits} (from afar).
  They give him armour, corpses, and living prisoners, while he gives them a place to store their gold, and the occasional \glsentrytext{talisman}}
}
...
\newglossaryentry{forestpriest}{
  ...
  type={people},
  parent={outsiders},
  description={is a half-elvish Ranger of the \glsentrytext{guard}, who frequently ignores orders.
  He hunts for people who smuggle food to the \glsentrytext{whiteBandits}, and desperately wants to know what happened with to \glsentrytext{lostcity}}
}
...
\newglossaryentry{banditking}{
  name={Antonym},
  first={Antonym \glsentrytext{whiteplains}},
  type={people},
  parent={whiteBandits},
  description={and his brother \glsentrytext{sewerking} want to replace the local \glsfmtplural{warden}.
  \\
  He travels the land, killing nobles with his men.
  All of them can pass into town, and live fairly well, as he keeps a healthy chest of coins with \glsentrytext{necromancer}}
}
...
\newglossaryentry{sewerthief}{
  name={Mossfall},
  first={Mossfall \glsentrytext{whiteplains}},
  type={people},
  parent={whiteBandits},
  description={just wants to enjoy life's comforts, but has to travel between a stinking sewer, and \glsentrytext{necromancer}'s crumbling temple to fetch more coins.
  \\
  \\
...
\newglossaryentry{nurabaron}{
  ...
  type={people},
  parent={establishment},
  description={was a jovial and simple \glsentrytext{warden}, loyal to \glsentrytext{townmaster}, until \glsentrytext{sewerking} gave him a horrifying hunger, using Life magic.
  \\
  \\
  Now, he and his family mismanage their estate and spend all day eating}
}
...
\newglossaryentry{captain}{
  ...
  type={people},
  parent={establishment},
  description={once worked in the \glsentrytext{guard}, but now stays in \glsentrytext{town}, managing the \glsentrytext{sunGuard} as their captain}
}
...
\newglossaryentry{alchemist}{
  ...
  type={people},
  parent={establishment},
  description={is the head \glsentrytext{seeker} of the \glsentrytext{paperGuild}, who works for \glsentrytext{townmaster} in \glsentrytext{town}'s citadel}
}
...
\newglossaryentry{librarian}{
  ...
  type={people},
  parent={establishment},
  description={organizes the local \glsentrytext{paperGuild}}
}
