...
The cat's name is Mog, and his collar is made from dried, woven daffodil.  The collar is activated by shouting the elvish word for `dragon', at which point Mog will turn into a morph cat.%
\footnote{The collar was a gift from \gls{sewerking}.}
...
\morphcat[\NPC{\N\A}{Mog}{slick}{licks paw}{colourful birds}]
...
The first member of the party to go down the tunnel rolls to spot the tripwire (\roll{Wits}{Vigilance}, \tn[8]), and failure means they immediately go tumbling downwards to the sewers.
