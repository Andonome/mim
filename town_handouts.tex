...
\begin{minipage}{\linewidth}
  ...
  \begin{nametable}[Lcc]{\glsentrytext{forestpriest}'s \glsentrytext{doulaShop}}
...
\begin{nametable}[Lcccc]{At the \Glsentrytext{templeOfHate}}
  ...
  \showArmourPrice{\partialchain}{5}%
  \showArmourPrice{\completechain}{5}%
  \showArmourPrice{\partialplate}{5}%
  \showArmourPrice{\completeplate}{5}%
