...
Every man, woman, and spider in the book has \pgls{statblock}, with \glsentrylongpl{hp} boxes, like this: \setcounter{wounds}{2} \setcounter{freeHP}{3}\hpStat, so you can score through their \glspl{hp} with the fanciest pen you have.
...
The book contains all the rules and lore that it needs, but it does not introduce either in a friendly manner.
To make sense of this \glsfmttext{campaign} you ony need to run a \pgls{bind} module or session and everything here should make sense after that.

You'll need some way to generate random encounters, either the full \textit{Judgement} book, or just print of the weekly \textit{Almanac} before each session.
...
and
\glsentrytext{lochside} \glsentrytext{village}, page \pageref{Dyson_Logos/lochside}.
...
\paragraph{Irina}
for the map of \glsentrytext{valley}, page \pageref{Irina/greylands}.
