...
He plans a meeting with them in a random tavern, then goes to \gls{pig}, where he introduces them to \gls{sewerking}.

\bigLine

This \gls{thread} arc runs in parallel with \nameref{sewerking} (\vpageref{sewerking}), then \nameref{risingTitles} (\vpageref{risingTitles}).
