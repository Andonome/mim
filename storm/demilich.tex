...
\Gls{necromancer} has destroyed yet another \gls{village}, and now has a horde of \arabic{segNo}00 ghouls, along with some ghasts.
...
By this time, \gls{necromancer} has gathered an army of \arabic{segNo}00 undead, and 4 ghasts.
...
\Gls{oldTemple} now hosts \arabic{segNo}00 ghouls, a few ghasts, and an undead \gls{basilisk}.%
...
\Gls{necromancer} now has a horde of \arabic{segNo}00 ghouls, along with a few ghasts, and an undead, armour-plated \gls{basilisk}.
...
\Gls{necromancer} has gathered an army of \arabic{segNo}00 ghouls.
...
He now boasts an army of \arabic{segNo}00 ghouls.
