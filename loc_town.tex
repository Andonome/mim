...
\humandiplomat[\NPC{\F\Hu}{\Gls{seeker} Foxglove}{running nose}{sings `Nobody Knows the Trouble I've seen'}{to find that missing cat}]
...
\begin{itemize}
  ...
  \item
  Researching the local area might bring up a map of the whole of Maitavale (\roll{Intelligence}{Wyldcrafting}, \tn[14]).
  \item
