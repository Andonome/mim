\mapArea[curiosity]{green_tower}{\Glsfmttext{greentower}}
...
The \gls{greentower} exists wherever the \glspl{pc} discover it, \vpageref{green_tower_sq}.
\Gls{southSeeker} will arrive after \pgls{interval}, so the \glspl{pc} may have to endure an encounter before meeting him.

\histEvent{5962}{9}{Priests at the temple of \glsfmttext{eldren} discover a deep pit, where highly valuable glowshrooms grow \glsfmttext{sickness}}
...
\histEvent{5963}{3}{The `Golden Priests' of \glsfmttext{eldren} begin an eternal war with goblins for the mushrooms \N}
...
\person{3}% STRENGTH
  ...
  {3}% COMBAT
  {}% SKILLS
  {\shortsword, \completeplate, pendant necklace worth 2~\glspl{gp}, silver earrings worth 1~\gls{gp} each, and 2 golden rings worth 5~\glspl{gp} each}% EQUIPMENT
  {
...
\npc{\T[11]\N\D}{\arabic{noAppearing} Undead Goblins}
\animal{-1}% STRENGTH
  {0}% DEXTERITY 
  {-1}% SPEED
  {2}% WITS
...
\npc{\T[2]\N\D}{\arabic{noAppearing} Hobgoblin Ghasts}
\person{2}% STRENGTH
  {1}% DEXTERITY 
  {-1}% SPEED
  {{-2}% INTELLIGENCE
...
\npc{\M\D\N}{\arabic{noAppearing} Hobgoblin Ghasts}
\person{2}% STRENGTH
  {1}% DEXTERITY 
  {-1}% SPEED
  {{-2}% INTELLIGENCE
  ...
  {2}% COMBAT
  {}% SKILLS
  {\javelin, fishing rod, glowshrooms $\times 3$}% EQUIPMENT
  {
    \setcounter{Projectiles}{1}
    \setcounter{Caving}{2}
    \setcounter{Tactics}{1}
