...
\newglossaryentry{beardedalemaster}{
  name={Sailhush},
  first={Sailhush (\glsentrytext{nomad} of the \glsentrytext{southDale}'s \glsentrytext{wheat})},
  text={Sailhush},
  type={people},
  description={is the leader of the \glsentrytext{wheat} in \glsentrytext{southDale}, and became rich selling watered-down dwarvish ale},
}
...
\newglossaryentry{southDale}{
  name={Southdale},
  description={is a set of towns, some distance to the South, allied with \glsentrytext{town}}
}
