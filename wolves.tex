...
\begin{enumerate}
  ...
  \item{The party refused to gather payment from the local peasants, but have sworn a blood oath to kill Village Master Cronblight.}
\end{enumerate}

This last rumour isn't entirely accurate -- the Wolf Heads are irritated with Village Master Cronblight (see page \pageref{cronblight}), but have not sworn an oath to kill him.
...
The games are mostly in good faith, but if the party have any obviously valuable items, Courtbile will attempt to steal it from them.
...
\NPC{\M}{Kinbrine}{Quiet}{Clicks tongue}{arcane knowledge}
\person{1}% STRENGTH
{0}% DEXTERITY 
{-1}% SPEED
{{2}% INTELLIGENCE
...
By the time the party arrive (assuming they come towards the cries) Betslick is unconscious (-3 HP), and Courtbile is nearly dead (2 HP left).
