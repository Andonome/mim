...
He comes up with any number of excuses -- `the \gls{guard} \glspl{jotter} won't accept the need for \pgls{broch} here', `the locals need \pgls{broch}', `the \gls{templeOfLight} want a private research outpost', and eventually admit that the \gls{templeOfLight} want to know more about \gls{lostcity}.
