...
\artefact{Peeping Orb}% Name
  {A perfect sphere, made of green glass, riddles with hydrogen gas-bubbles}% Body
  {0}% Intelligence
  {-1}% Wits
  {2}% Charisma
...
%! Memory orb: Makes illusions of people it's seen.
% It shows the sleepers as younger people.
