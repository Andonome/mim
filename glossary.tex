...
\longnewglossaryentry{oldTemple}{
  ...
  type={people},
  category={location},
  description={once held priests of \glsentrytext{eldren}, and a single guardian remains, to guard the temple, even in death},
}
...
\longnewglossaryentry{necromancer}{
  ...
  parent={oldTemple},
  symbol={\D\M\Hu},
  description={has spent so long alone that he has developed a phobia of the living.
  But when \glsentrytext{banditking} stole his only friend, he decided to raise an undead army by destroying local \glsfmtplural{village}, and will continue killing everything which scares him, until he reunites with \glsentrytext{bskulls} (who currently rests under \glsentrytext{town})},
}
