...
\mapPic[\large]{t}{Dyson_Logos/map_circles}{
  ...
  \gls{southDale}/93/35,
  \D~\nameref{necromancers_lair}/13/18,
  \rotatebox{55}{\normalsize\glsentrytext{lakeside}}/85/49,
...
Over the course of these Side~Quests, monstrous invasions will wipe out some of those little \glspl{village} and hamlets, which puts the troupe in a dangerous situation.
