...
\histEvent{350}{5}{The Vore Gate opens in Sixshadow}
...
\subsection[Downstairs]{\glsentrysymbol{yonder}~Downstairs~\glsentrysymbol{abderian}}
...
\histEvent{300}{1}{The six gnomes who work at the Shadow Vault build an alchemical gateway to \glsentrytext{archwarp} called `the Shadow Gate', and instruct it to open for anyone who can answer its riddles}
