\section{Vault of the Shadow Gate}
...
\histEvent{5953}{01}{The six gnomes who work at the Shadow Vault build a gateway to Archwarp, and instruct it to open for anyone who can answer its riddles.}
...
\begin{exampletext}
  ...
  So with some slow, quiet work, over years, they created a passage from their little `janitor's closet' to the Vore Gate enclosure.
\end{exampletext}
...
\histEvent{5980}{4}{%
  The \glsentrytext{warden} of \glsentrytext{town} asks a gnome, who works at the Shadow Vault, to ask the Shadow Gate an impossible riddle.
  The Shadow Gate halts in contemplation, and in return, he and the other gnome workers may open a warren just outside of \glsentrytext{town}.
}
