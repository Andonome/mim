...
\histEvent{266}{2}{\Glsentrytext{deep} gnomes establish a warren outside of \glsfmttext{town}}
...
\Person{\NPC{\Gn\E}{\Glsfmttext{thane} Tompf}{cleans glasses (refuses to explain what `glasses' are)}{wanders off quietly, while people are talking}{to never feel the sting of boredom}}%
  {{1}{3}{2}}% BODY
  {{2}{1}{1}}% MIND
  {%
