...
\longnewglossaryentry{gatekeepers}{
  name={The Gate Keepers},
  text={gate keeper},
  prefix={a\space},
  type={people},
  category={exposition},
  description={are not a group.
  They are the set of people old enough to remember the problems once caused by alchemical gateways or underground tunnels to unknown locations.
  None of them want to see those problems again},
}

\longnewglossaryentry{forgottenDead}{
  name={The Dead},
...
\longnewglossaryentry{oolery}{
  ...
  type={people},
  category={location},
  description={was established by a tiny crew gnomes from the \glsentrytext{deep}, and since grew to host over a hundred}
}
