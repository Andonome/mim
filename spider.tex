...
She has also begun magically deforming her own body to look progressively more like a chitincrawler.
...
Chitincrawlers hibernate over the colder seasons, so if \gls{fenestra} enters a cold season, skip these encounters until later.%
\exRef{judgement}{Judgement}{astronomy}

\sqpart{Roads}% AREA
{\squash~Luckiest Trader Alive}% NAME
{A seller tells the troupe about her luck escaping chitincrawlers}% SUMMARY

The \glspl{pc} meet a trader who seems infectiously happy after escaping a near-death experience.

\begin{exampletext}
  Gls{spiderqueen} sent her chitincrawlers after the trader -- Barkridge -- along with illusionary crawlers.
...
\begin{enumerate}
  ...
  \item
  As the real chitincrawlers grab the characters, they will be taken by surprise.
\end{enumerate}
...
{The \gls{spiderqueen}'s chitincrawlers have eaten an entire hamlet}% SUMMARY
...
\begin{speechtext}
  \small
  There's that creature -- looks like \gls{sylf} went and fucked an elf -- she just went past with half a dozen chitincrawlers following her.
...
Ask the players to make the roll, without \pgls{tn}, give them the results, then ask if they want to press on while raising the~\gls{tn}.

\begin{nametable}{What they see\ldots}
  \textbf{\gls{tn}} & \textbf{Result} \\
  \hline
  6 & In the distance, you see trees covered in so much webbing it seems like a fortress of goo. \\
  7 & There's a feint silhouette of \gls{spiderqueen} in the very centre, with two chitincrawlers next to her. \\
...
someone needs to roll \roll{Charisma}{Tactics}, \tn[11].
...
\begin{exampletext}
  ...
  However, Leta is the decision-maker, and her nose is longer than \gls{keras}'s,\footnote{Gnomes consider this to be an important point.} so she says there's no use talking to the troupe without testing if they really can fight chitincrawlers.
  Mayelo, meanwhile, just wants both of them to stop fighting and make a decision.
  He's been depressed ever since their \gls{village} was eaten by chitincrawlers.
...
The players should be aware that if they jump out \emph{near} \gls{spiderqueen}, but not near enough, the dozen chitincrawlers will sprint towards them instantly.
