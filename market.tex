...
Specialized items require a \roll{Charisma}{Vigilance} roll to find (\tn[12]).
...
\begin{boxtable}[Xcc]
  ...
  \label{warmClothes}
  Temp: \arabic{temperature} Warm clothes &  2 &  \ifnum\value{temperature}=0 6\else 2\fi \glspl{sp} \\
...
\begin{boxtable}[Xcc]
  ...
  Rations for a day &  1 &  \ifnum\value{temperature}>0 15\else 30\fi \glspl{cp} \\
