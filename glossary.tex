...
\newcommand\southRogue{
  \NPC{\glssymbol{southRogue}}{\Glsentrytext{southRogue}}{black pony-tail}{thumbs up}{your Money}
  \person{0}% STRENGTH
  {2}% DEXTERITY 
  {1}% SPEED
  {{0}% INTELLIGENCE
...
\newglossaryentry{southRogue}{
  ...
  parent={wolfhead},
  symbol={\F\Hu},
  description={has too much energy, so \glsentrytext{southDale} tossed her in the \glsentrytext{guard}.
  Then she jumped out of the \glsentrytext{guard} and onto an adventure with new people to steal from},
}
