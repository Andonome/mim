...
\Gls{southCook} wants to know more about the local \gls{guard}, so she sends \glsentrytext{southRogue} out to find out what the score is.
...
\basilisk[\npc{\T[6]\A}{\arabic{noAppearing} \Glspl{basilisk}}]
