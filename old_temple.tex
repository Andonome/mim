...
Assuming the troupe have no magic to make them less visible to the dead, then \gls{necromancer} will spot them, and begin \gls{casting} offensive spells (check his abilities \vpageref{antTower}).
