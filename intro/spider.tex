...
\Glspl{crawler} hibernate over the cold seasons, so if \gls{fenestra} enters a cold season, skip this \gls{sq} until \gls{fenestra} returns to \gls{ainumar}'s warmth.
