...
\newglossaryentry{sewerking}{
  ...
  \\
  \\
  After trading armour with \glsentrytext{necromancer} for a powerful \glsentrytext{artefact}, he will begin to steal corpses from the bowels of  \glsentrytext{town}, and raise them from the dead.
