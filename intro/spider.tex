...
\Glspl{crawler} hibernate over \gls{cTwo}, so if your game takes place around \gls{cOne}, and \gls{fenestra}'s Winter is about to hit, skip this \gls{sq} until \gls{fenestra} returns to the \gls{ainumar}'s warmth in \gls{cThree}.
