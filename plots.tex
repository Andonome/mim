...
should begin with character creation as usual,%
\exRef{stories}{Stories}{randomCharacterCreation}
then a roll to determine where the character comes from.
...
\begin{dlist}
  ...
  \item
  The character come from the farmlands around \gls{town}; they've always had a fairly peaceful life, and barely seen a single \glsentrytext{monster} in their life.
  \item
  The character comes from one of the outer \glspl{village} in \gls{valley}.
  \item
