...
\newglossaryentry{wolfhead}{
  ...
  plural={Wolf Heads},
  type={people},
  description={\textit{This \glsentrytext{valley} holds secrets, still half-remembered in old songs.
...
\newglossaryentry{diggers}{
  ...
  So we're gonna cut it down to size, starting with the head, and then we'll make our own version of justice}},
}
