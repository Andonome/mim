...
from the faraway \gls{wheatGuild} of \gls{southDale}, and has them cause trouble in order to give her rivals a bad name all around \gls{town}.
In retaliation, \gls{beardedalemaster}, dignitary to \gls{southDale} \gls{wheatGuild}, destroys much of the local ale stores.
...
{A knight of the local \gls{wheatGuild} starts fights while pretending to be from the \gls{wheatGuild} of \glsentrytext{southDale}}% SUMMARY
...
He's a member of the local \gls{wheatGuild}.
He's acting drunk and showing a symbol of \gls{southDale}' \gls{wheatGuild} in order to give the rival sellers a bad reputation.

Players may notice he's pretending to be drunk with a Wits + Medicine Group Roll, or notice that his coat of arms isn't painted onto his breastplate quite right with a \roll{Wits}{Academics} Roll.
Both have \tn[10].

\NPC{\M}{\Gls{server} Carnpox}{Bobbing Adams Apple}{Pointing at people}{to get paid}
...
\textbf{Background:} The local \gls{wheatGuild} found that the more ale is brewed in a batch, the cheaper it becomes.
...
\begin{boxtext}
  ...
  The crowd shout for them to go back to the mountains and that they're not welcome in the area, but a dwarf, covered in metal from head to toe, and wearing the emblem of the \gls{wheatGuild} from \gls{southDale}, lifts his metal visor and shouts back at them, listing a litany of laws concerning public houses and the rights of foreign \gls{server}, with deafening volume.
...
A travelling troupe of three men and three dwarves from \gls{southDale} are tired from a long day's walk, and need a rest and drink, but the townsfolk think of the \gls{wheatGuild} from \gls{southDale} as nothing but troublemakers.
