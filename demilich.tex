...
\label{necroStory}
\histEvent{5987}{05}{\Glsfmttext{necromancer} swears to protect his temple}
\begin{exampletext}
  \noindent
  ...
  \histEvent{6051}{5}{\Glsfmttext{necromancer} kills two burglars, and uses their bodies to make \glsfmttext{bskulls}}
...
\sqpart{Roads}% AREA
{\gls{squash}~\gls{vlg}~The Undead Horde}% NAME
