\mapArea[poison]{mincingPig}{\Glsentrytext{pig}}
\index{Taverns}
...
Whenever \gls{sewerking} wants to store some valuables, he tells the other \glspl{whiteBandits} that he wants to place something in his `treasure room', then enters the side with the secret hatch, and stuffs it in.

To stop people stealing from him, he placed a bag of \glsentrylongpl{cp} beside the hatch, so would-be thieves could take that, instead of his actual valuables.
He also placed a ghast inside the room, ready to spring out whenever anyone opened the door.

If the \glspl{whiteBandits} ever have serious need of cash, he will stab through the wood, killing the ghast before he enters.
