...
\mapPic[\Large]{b}{Dyson_Logos/green_tower}{
...
\Gls{greentower} exists wherever the \glspl{pc} discover it, \vpageref{green_tower_sq}.
\Gls{southSeeker} will arrive after \pgls{interval}, so the \glspl{pc} may have to endure an encounter before meeting him.

\histEvent{295}{9}{Priests at the temple of \glsfmttext{eldren} discover a deep pit, where highly valuable glowshrooms grow \glsfmttext{sickness}}
...
\histEvent{287}{3}{The `Golden Priests' of \glsfmttext{eldren} begin an eternal war with goblins for the mushrooms \N}
