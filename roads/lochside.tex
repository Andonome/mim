...
\histEvent{229}{3}{\Glsfmttext{warden} Fuscia Grey, Klept's daughter, establishes the \glsentrytext{lochside} \glsentrytext{broch}}

The \gls{village}'s central square contains a statue of \Gls{warden} Fuscia Grey looking lordly.
She funded the initial \gls{broch} here to ensure the safety of the port, and all its taxes.
