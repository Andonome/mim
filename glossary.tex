...
\newglossaryentry{alemaster}{
  name={Jerina},
  first={Alemaster Jerina},
  description={is the highest ranking member of the temple of Alass\"{e}, who are synonymous with the Ale Guild. Also known locally as `that damned Jerina'}
}
...
\person{2}% STRENGTH
  ...
  {0}% DR
  {2}% COMBAT
  {Athletics~2, Deceit~1, Larceny~1, Wyldcrafting~2\knacks{\adrenalinesurge, \charge}}% SKILLS
