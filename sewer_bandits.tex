...
\noindent
\Gls{sewerking} has built an underground lair, and is using it to build a team of bandits.
...
The \gls{whiteBandits} in the sewers have a real fight on their hands, as the ghast freed some of the less intelligent undead, and they don't have enough rings to remain safe from the undead.
