...
\artefact{Peeping Orb}% Name
  {A perfect, black sphere, made of cooled magma, the size of a head}% Body
  {0}% Intelligence
  {-1}% Wits
  {2}% Charisma
...
\setcounter{wounds}{2}
\artefact{Nuisance Rock}% Name
  {A small rock, covered by the illusion of a massive diamond.}% Body
  {-1}% Intelligence
  {1}% Wits
  {2}% Charisma
