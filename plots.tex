...
Have a glance `\nameref{sqList:Forest}' \vpageref{sqList:Forest}, with the \gls{sq} list and locations, then fold the page-corner over, so you can find the next \gls{segment} and location descriptions easily.
...
Fold the corner of \vpageref{sqList:Roads} so you can check available \glspl{segment} quickly.
...
\sideBySide{
  ...
  \noindent
  Looking up the \gls{sq} list \vpageref{sqList:Roads}, the \gls{gm} finds the first available \gls{segment}:
...
\begin{enumerate}
  \item
  Grab \pgls{pc} sheet, or roll up a random character, then check their background \vpageref{greyBackgrounds}, `\nameref{greyBackgrounds}'.
  \item
  Start in \nameref{cinderfilch} \vpageref{cinderfilch}, and check the first \gls{segment} available in the \gls{region} (\vpageref{sqList:Roads}).
  \item
  ...
  \item
  Give the character all the \glspl{gp} they might need for rations or new \glspl{weapon}, then check the market handouts before the Roads \gls{region}.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item
  Check the next available \gls{sq} \gls{segment} (\vpageref{sqList:Roads}).
\end{enumerate}
