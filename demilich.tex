...
{A botched spell leaves \glsentrytext{necromancer}'s ghousl wandering along}% SUMMARY
...
Run this part when the troupe approach a \gls{village}.
...
Have the players roll \roll{Wits}{Wyldcrafting} (\tn[14] or higher).
...
\sqpart{Roads}% AREA
{The Survivors}% NAME
{A \glsentrytext{village} has been ransacked by ghouls, and only followers of Qualm\"{e} have been spared}% SUMMARY
...
Rupert, Jake, Sarah and Eliza cannot explain why they were spared -- they only know the undead never touched them while they ate the rest of the \gls{village}.
